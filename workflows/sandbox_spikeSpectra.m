...
% *** NOTE: need tetrode number to prevent spike-field data for same tt LFP! ***
% cfg = [];
% cfg.cMethod = 'Sirota';
% s_out = CategorizeStriatumWave(cfg,S);
...
%     S.usr.tetrodeDepths(iCell) = ExpKeys.tetrodeDepths(S.usr.tt_num(iCell));
% end
